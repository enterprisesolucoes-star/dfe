...
import { 
  ...
  Hash, Ruler, CreditCard, Truck, ShieldCheck, Building, Settings, LogOut, Zap, UserCircle, TrendingUp, Landmark, FileText
} from 'lucide-react';
      ...
      <nav className="flex-1 p-4 space-y-1.5 overflow-y-auto custom-scrollbar">
        ...
        <div>
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
              cadastrosOpen || ['ncm', 'usuarios', 'medidas', 'bandeiras', 'transportadores', 'vendedores', 'comissoes', 'cobranca_config', 'cobranca_boletos', 'config_integracao', 'dfe_config', 'dfe_nfe_dados', 'dfe_nfce_dados', 'dfe_provedor'].includes(activeTab) ? 'text-blue-600 font-bold bg-blue-50/50' : 'text-gray-500 hover:bg-gray-50'
            }`}
          >
