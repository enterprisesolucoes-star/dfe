...
const LoginScreen = ({ onLogin }: { onLogin: (s: Session, lembrar: boolean) => void }) => {
  ...
  if (manutencao) return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-blue-900">
      <div className="bg-white dark:bg-[#0f1420] rounded-2xl shadow-2xl p-10 w-full max-w-sm text-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Sistema em Manutenção</h2>
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Estamos realizando melhorias no sistema. Por favor, aguarde alguns minutos e tente novamente.</p>
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/95 dark:bg-[#0f1420]/95 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-sm p-8 relative z-10 border border-white/20 dark:border-gray-700">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">DFe IA v2</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Sistema de Emissão Fiscal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="login"
                autoFocus
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white dark:bg-[#0a0e1a] text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
              />
            </div>
          </div>
          <div>
          ...
          <label className="flex items-center gap-2 cursor-pointer select-none">
            ...
            />
            <span className="text-sm text-gray-600 dark:text-gray-300">Lembrar-me neste dispositivo</span>
          </label>
        ...
        <p className="text-center text-xs mt-6 text-gray-400 dark:text-gray-500 hover:text-blue-500 transition-colors cursor-pointer">
